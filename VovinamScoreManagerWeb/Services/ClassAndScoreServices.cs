...
namespace VovinamScoreManagerWeb.Services
{
    public class ClassAndScoreServices
    {
        ...
        public List<Class> GetLstClasss(Class filter)
        {
            ...
            {
                Classs = Classs.Where(x => x.AccountId== filter.AccountId).ToList();
            }
            return Classs;
        }
        ...
        public List<Score> GetLstScore(Score filter)
        {
            ...
            foreach (var item in Scores)
            {
                ...
                item.Student.Rank = context.Ranks.Where(x => x.Id == item.Student.RankId).FirstOrDefault();
            }
